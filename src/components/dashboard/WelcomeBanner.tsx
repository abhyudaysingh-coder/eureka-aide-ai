...
export const WelcomeBanner = ({ user }: WelcomeBannerProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl gradient-hero p-12 text-white shadow-xl">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap gap-4">
          <Button
            ...
            className="glass border-white/40 text-white hover:bg-white/20 hover:border-white/60"
          >
